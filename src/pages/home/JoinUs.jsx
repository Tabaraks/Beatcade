...
export const JoinUs = () => {
  ...
  const togglePlay = () => {
    if (currentPlayer) {
      if (isPlaying) {
        ...
        setManageProgress(Tone.now() - currentPositionInSeconds);
        currentPlayer.start("+0", startTime);
      }
  ...
  useEffect(() => {
    const updateProgress = () => {
      if (!manageProgress || !currentPlayer) return;

      const currentPosition = Tone.now() - manageProgress;
  ...
  }, [currentPlayer, startTime, manageProgress]);
      ...
      {snap.page === PAGES.joinus && !snap.model && (
        <div className="flex w-full absolute md:top-[15%] md:left-[5%] lg:top-[15%] lg:left-[5%] xl:left-[12%] gap-x-[50px]  z-50 md:gap-x-[50px]">
          <div className="relative">
            ...
            <div className="flex flex-col gap-y-2 absolute top-[60%] lg:left-[30%]  md:left-[27%] text-center">
          ...
          <div className="relative">
            ...
            <div className="flex flex-col gap-y-2 absolute top-[60%] left-[23%] md:left-[24%] xl:left-[25%] text-center">
          ...
          <div className="relative">
            ...
            <div className="absolute top-[5%] lg:left-[35%] md:left-[32%] flex flex-col items-center gap-y-6">
